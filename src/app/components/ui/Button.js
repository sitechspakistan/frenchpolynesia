...
const Button = ({
  ...
  const base =
    "inline-flex items-center justify-center font-light text-sm md:text-base capitalize px-3 py-2 md:px-6 md:py-4 rounded-md transition-colors tracking-wide";
