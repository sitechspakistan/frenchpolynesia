...
export default function Hero() {
  return (
    <section
      className="relative flex items-end  bg-cover bg-center h-[500px] md:h-[750px]"
    ...
    >
      ...
      <div className="absolute w-full backdrop-blur-xs z-8 bottom-0 left-0 bg-white/10 border-t border-white/10 overflow-hidden">
        <div className="max-w-7xl mx-auto py-6 flex items-center justify-between px-4 md:px-6">
          {/* Left: Heading */}
          <h1 className="flex-1 md:flex-2 text-white text-left font-bold md:font-extrabold text-2xl md:text-5xl uppercase leading-tight ">
